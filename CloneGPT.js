...
async function clone(question) {
  ...
  let response = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyDMLNq4PXKIRMB07H-vg8ugGCcIjW5_uH4", {
    method: "POST",
    headers: {
